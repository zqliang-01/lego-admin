...
@Service
public class SysColumnSortService extends BusiService<ISysColumnSortDao, SysColumnSortAssembler> implements ISysColumnSortService {

	@Override
	public List<SysColumnSortInfo> findBy(String permissionCode, String employeeCode) {
		List<SysColumnSort> tableColumnSorts = dao.findByPermission(permissionCode, employeeCode);
		return assembler.create(tableColumnSorts);
	}

	@Override
	public void updateBy(String permissionCode, String employeeCode, List<String> fieldCodes) {
		List<SysColumnSort> tableColumnSorts = dao.findByPermission(permissionCode, employeeCode);
