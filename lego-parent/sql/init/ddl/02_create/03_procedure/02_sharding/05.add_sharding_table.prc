...
BEGIN
	...
	INSERT INTO sharding_table
	    (ID, CODE, NAME, DESCRIPTION, LOGIC_TABLE_NAME, ACTUAL_DATA_NODES, ALGORITHM_ID, SHARDING_COLUMN, TEMPLATE_ID, CONFIG_ID, VERSION, ENABLE, CREATE_TIME)
	VALUES
	    (vId, vCode, vName, NULL, vLogicTable, vActualTable, vAlgorithmId, vShardingColumn, vTemplateId, vConfigId, 1, 1, sysdate());
END;