...
public class ShardingDataSourceController extends BaseController {
    ...
    @PostMapping("/add")
    @SaCheckPermission("manage:sharding:dataSource:add")
    ...
    @PostMapping("/update")
    @SaCheckPermission("manage:sharding:dataSource:update")
    ...
    @PostMapping("/delete")
    @SaCheckPermission("manage:sharding:dataSource:delete")
    ...
    @PostMapping("/list")
    @SaCheckPermission("manage:sharding:dataSource:read")
    ...
    @GetMapping("/get/{code}")
    @SaCheckPermission("manage:sharding:dataSource:detail")
    ...
    @PostMapping("/export")
    @SaCheckPermission("manage:sharding:dataSource:export")
